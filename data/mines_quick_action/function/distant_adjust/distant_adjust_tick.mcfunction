...
execute as @a[scores={mines.adjust_block_diatant=1},gamemode=survival] run attribute @s block_interaction_range modifier remove minecraft:mines_attributes
...
execute as @a[scores={mines.adjust_entity_diatant=1},gamemode=survival] run attribute @s entity_interaction_range modifier remove minecraft:mines_attributes
