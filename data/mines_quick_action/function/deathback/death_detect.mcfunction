...
execute as @a[scores={mines.deathOperate=2}] run function mines_quick_action:deathback/set_spawnpoint_jump

execute as @a[scores={mines.ifDeath=1,mines.deathOperate=1}] run function mines_quick_action:deathback/track_back
