...
$execute if score #dummyCurrentIndex mines.projection_block matches $(max_step)..6000 run say 没找到方块
$execute if score #dummyCurrentIndex mines.projection_block matches $(max_step)..6000 run return fail
