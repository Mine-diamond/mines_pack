...
$execute unless score @s mqp.core.message_feedback matches 0 unless data storage mqp_wp:temp move.current.dim run tellraw @s [{"text":"[快捷功能:路径点]","color":"white"},{"text":" 路径点 ","color":"red"},{"text":"$(id)","color":"yellow"},{"text":" 不存在，无法上移","color":"red"}]
