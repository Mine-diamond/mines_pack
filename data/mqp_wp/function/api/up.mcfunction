...
execute unless score @s mqp.core.message_feedback matches 0 unless score #id wp_calc matches 2.. run tellraw @s [{"text":"[快捷功能:路径点]","color":"white"},{"text":" 该路径点已经在最上方，无法上移","color":"red"}]
