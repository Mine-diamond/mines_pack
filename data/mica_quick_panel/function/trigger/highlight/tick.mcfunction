execute as @a[scores={mqp.trigger.highlight.entity_enabled_flags=1..}] run function mica_quick_panel:module/highlight/switch_entity_highlight
...
execute as @a[scores={mqp.trigger.highlight.player_enabled_flags=1..}] run function mica_quick_panel:module/highlight/switch_player_highlight
...
execute as @a[scores={mqp.trigger.highlight.item_enabled_flags=1..}] run function mica_quick_panel:module/highlight/switch_item_highlight
