execute as @a[scores={mqp.trigger.clear_entity.switch_mob_loot=1..}] run function mica_quick_panel:module/clear_entity/switch_gen_drops
...
execute as @a[scores={mqp.trigger.clear_entity.switch_kill_type=1..}] run function mica_quick_panel:module/clear_entity/switch_kill_type
...
execute as @a[scores={mqp.trigger.clear_entity.clear_entity=1..}] run function mica_quick_panel:module/clear_entity/clear_entity
