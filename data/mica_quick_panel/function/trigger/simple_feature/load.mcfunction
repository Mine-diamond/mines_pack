scoreboard objectives add mqp.trigger.simple_feature.night_version trigger
scoreboard objectives modify mqp.trigger.simple_feature.night_version displayname "修改夜视效果"
scoreboard players enable @a mqp.trigger.simple_feature.night_version

scoreboard objectives add mqp.trigger.simple_feature.invulnerable_mode trigger
scoreboard objectives modify mqp.trigger.simple_feature.invulnerable_mode displayname "修改无敌模式"
