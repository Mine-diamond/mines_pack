...
execute as @a[scores={mqp.trigger.interaction_setting.entity_switch_force_mode=1..}] run function mica_quick_panel:interaction_setting/entity_interaction_distance_setting/switch_force_mode
