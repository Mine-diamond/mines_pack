execute as @a[scores={mqp.trigger.way_point.tp=1..}] run function mica_quick_panel:way_point/trigger/tp
...
execute as @a[scores={mqp.trigger.way_point.new=1..}] run function mica_quick_panel:way_point/trigger/new
...
execute as @a[scores={mqp.trigger.way_point.del=1..}] run function mica_quick_panel:way_point/trigger/del
...
execute as @a[scores={mqp.trigger.way_point.up=1..}] run function mica_quick_panel:way_point/trigger/up
...
execute as @a[scores={mqp.trigger.way_point.down=1..}] run function mica_quick_panel:way_point/trigger/down
