execute as @a[scores={mqp.trigger.time_setting=0..}] run function mica_quick_panel:module/time_setting/set_time_init
...
execute as @a[scores={mqp.trigger.moon_phase=0..}] run function mica_quick_panel:module/time_setting/set_moon_phase
