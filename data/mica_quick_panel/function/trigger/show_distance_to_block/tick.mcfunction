execute as @a[scores={mqp.trigger.show_distance_to_block.switch_enable=1..}] run function mica_quick_panel:module/show_distance_to_block/switch_enable
...
execute as @a[scores={mqp.trigger.show_distance_to_block.set_detect_distance=0..}] run function mica_quick_panel:module/show_distance_to_block/set_detect_distance
