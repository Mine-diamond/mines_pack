execute if data storage mqp:kill_all_mob {close_mob_loot:1} run data modify storage mqp:kill_all_mob kill_all_mob_dialog_prepare.switch_mob_loot set from storage mqp:constant.word off
execute unless data storage mqp:kill_all_mob {close_mob_loot:1} run data modify storage mqp:kill_all_mob kill_all_mob_dialog_prepare.switch_mob_loot set from storage mqp:constant.word on
