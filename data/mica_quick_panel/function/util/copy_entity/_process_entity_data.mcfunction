...
function mica_quick_panel:util/copy_entity/_get_pure_type
...
execute if data storage mqp:util.copy_entity {remove_entity:1} run function mica_quick_panel:util/copy_entity/_remove_entity
