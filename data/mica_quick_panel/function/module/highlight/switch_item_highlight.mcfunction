...
execute unless score @s mqp.core.message_feedback matches 0 if score #temp mqp.temp matches 1 run tellraw @s "[快捷功能]§c已关闭物品高亮"
execute unless score @s mqp.core.message_feedback matches 0 unless score #temp mqp.temp matches 1 run tellraw @s "[快捷功能]§b已开启物品高亮"
