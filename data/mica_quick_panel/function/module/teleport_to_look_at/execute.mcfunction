execute at @s run function mica_quick_panel:module/teleport_to_look_at/start_projection with storage mqp:teleport_to_look_at

execute if data storage mqp:util.block_projection {success:1} run function mica_quick_panel:module/teleport_to_look_at/tp with storage mqp:teleport_to_look_at
