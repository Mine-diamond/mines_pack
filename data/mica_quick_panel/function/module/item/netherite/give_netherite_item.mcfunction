execute if score @s mqp.trigger.item.netherite.get matches 1001 run function mica_quick_panel:module/item/netherite/unenchanted/get_item
execute if score @s mqp.trigger.item.netherite.get matches 1002 run function mica_quick_panel:module/item/netherite/unenchanted/equip_item
execute if score @s mqp.trigger.item.netherite.get matches 1003 run function mica_quick_panel:module/item/netherite/enchanted/get_item {add_fortune:1}
execute if score @s mqp.trigger.item.netherite.get matches 1004 run function mica_quick_panel:module/item/netherite/enchanted/equip_item {add_fortune:1}
execute if score @s mqp.trigger.item.netherite.get matches 1005 run function mica_quick_panel:module/item/netherite/enchanted/get_item {add_fortune:0}
execute if score @s mqp.trigger.item.netherite.get matches 1006 run function mica_quick_panel:module/item/netherite/enchanted/equip_item {add_fortune:0}
