...
$execute if score #1 mqp.constant.number matches $(add_fortune) run function mica_quick_panel:module/item/netherite/enchanted/_give_common_item_fortune
$execute if score #0 mqp.constant.number matches $(add_fortune) run function mica_quick_panel:module/item/netherite/enchanted/_give_common_item_silk_touch