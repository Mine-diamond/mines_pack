...
execute if score #temp mqp.temp matches 1 run function mica_quick_panel:module/simple_feature/invulnerable_mode/disable_invulnerability
execute unless score #temp mqp.temp matches 1 run function mica_quick_panel:module/simple_feature/invulnerable_mode/enable_invulnerability
