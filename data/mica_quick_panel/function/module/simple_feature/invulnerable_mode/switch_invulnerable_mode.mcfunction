...
execute if score #temp mqp.temp matches 1 run function mica_quick_panel:module/simple_feature/invulnerable_mode/_disable
execute unless score #temp mqp.temp matches 1 run function mica_quick_panel:module/simple_feature/invulnerable_mode/_enable
