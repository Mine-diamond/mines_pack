...
execute unless score @s mqp.core.message_feedback matches 0 if score #temp mqp.temp matches 1 run tellraw @s ["[快捷功能]",{"text":"已禁用夜视","color":"red"}]
execute unless score @s mqp.core.message_feedback matches 0 unless score #temp mqp.temp matches 1 run tellraw @s ["[快捷功能]",{"text":"已启用夜视","color":"green"}]
