...
execute if score #temp mqp.temp matches 1 run tellraw @s ["[快捷功能]",{"text":"已禁用显示生物群系","color":"red"}]
execute unless score #temp mqp.temp matches 1 run tellraw @s ["[快捷功能]",{"text":"已启用显示生物群系","color":"green"}]
