...
execute if score #temp mqp.temp matches 1 run function mica_quick_panel:module/simple_feature/run_mode/disable_run_mode
execute unless score #temp mqp.temp matches 1 run function mica_quick_panel:module/simple_feature/run_mode/enable_run_mode
